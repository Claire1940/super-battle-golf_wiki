...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Super Battle Golf Wiki',
    description: 'Copyright and intellectual property information for Super Battle Golf Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Super Battle Golf Wiki',
      description: 'Copyright and intellectual property information for Super Battle Golf Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Super Battle Golf Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Super Battle Golf Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Super Battle Golf Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Super Battle Golf Developers</strong> - Creators of the Super Battle Golf game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Super Battle Golf</strong> - Trademark of the game developers</li>
              <li><strong>Super Battle Golf Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Super Battle Golf Wiki.
            </p>
            ...
            <p>
              ...
              Super Battle Golf Wiki<br />
              Email: <a href="mailto:dmca@super-battle-golf.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@super-battle-golf.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Super Battle Golf Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Super Battle Golf Wiki (super-battle-golf.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@super-battle-golf.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@super-battle-golf.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@super-battle-golf.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@super-battle-golf.wiki</a>
            </p>
            <p>
